...
from net.myapp.utils import set_style
from net.myapp.view.addnewstudentview import AddNewStudentView
from net.myapp.view.registerview import RegisterView
from net.myapp.view.studentview import StudentView
from net.myapp.view.subjectview import SubjectView, AddNewSubjectView
